...
$(document).ready(function(){
    ...
    $.get("../satzeargenzung/satzeargenzung.php", function(data, status){
        //satzArr edhe array qe cdo el i tij mban nje fjali, fjalite ndahen me <br> nga njera tjetra
        ...
        $(".next").click(function(){
            ...
            //ruaje ne db dhe na kalon te loja tjeter, ktu kam vene flashcardsin
            if (y == 6) {
                $.post("../satzeargenzung/punkt.php", {p: punkt}).done(function(data) {
    ...
    function checkOrd() {
        ...
        if (JSON.stringify(items) == JSON.stringify(itsort)){
            ...
            $(".answer").html('<p style="color: green; padding-top: 3%; font-size: 30px;"><b>Righ order</b></p><br />');
