...
<html lang="en">
<head>
	<title>Rede Satzanpassung - Langbook DE - Learn German the easy Way.</title>
...
<body>
			...
			<ul id="menu-content" class="menu-content collapse out">
				...
				<div class="container">
					<div class="row">
						...
						<div class="row">
							<audio id="myTune">
								<!-- <source src="../audio/klugsteMenschDerWelt.ogg">
								<source src="../audio/klugsteMenschDerWelt.mp3"> -->
							</audio>
							<button onclick="document.getElementById('myTune').play()" class="btn btn-lg btn-block btn-success"><span class="glyphicon glyphicon-volume-up"></span></button>
						</div>
	...
	<script src="../js/rede_satzearg.js"></script>
