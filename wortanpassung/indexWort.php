...
<html lang="en">
<head>
	<title>Wortanpassung - Langbook DE - Learn German the easy Way.</title>
	<meta name=viewport content="width=device-width, initial-scale=1">
	<link rel="stylesheet" href="../bootstrap-3.3.7-dist/css/bootstrap.min.css" type="text/css">

	<script src="../js/jquery-3.1.1.min.js"></script>
	<script src="../js/wortanpassung.js"></script>
	<script src="../bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>

	<script src="../js/all.js"></script>

	<link rel="stylesheet" href="../style/main.css" type="text/css">
	<link rel="stylesheet" href="../style/wortanpassung.css" type="text/css">
		...
		<div class="menu-list">
			<ul id="menu-content" class="menu-content collapse out">
				...
				<div class="container">
					...
					&nbsp;
					&nbsp;
						<div class="col-xs-8 col-xs-offset-4 bild"></div>
						<div class="col-xs-8 col-xs-offset-2 pull-right btn-ctrl">
							<button type="button" id="submit" value="Submit" class="btn btn-default btn-lg check0"><span class="glyphicon glyphicon-ok"></span></button>
						</div>

						<p class="col-xs-8 col-xs-offset-2 result" style="padding-top: 2%;"></p>
						<div class="col-xs-8 col-xs-offset-4" style="padding-top: 2%;"><button style="visibility: hidden" class='next btn btn-default btn-lg'>Next</button></div>
					</div>
